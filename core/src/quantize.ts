// Pure quantization + tile-splitting. Both platforms feed this a raw
// RGBA buffer and get back a flat array of palette entries.

import { closestEntry } from "./palette.ts";
import type {
  ColorMetric,
  DitherMethod,
  Palette,
